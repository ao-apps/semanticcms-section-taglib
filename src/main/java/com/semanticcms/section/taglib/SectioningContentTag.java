...
abstract public class SectioningContentTag<SC extends SectioningContent> extends ElementTag<SC> {
	...
	/**
	 * @deprecated  You should probably be implementing in {@link #writeTo(javax.servlet.ServletRequest, com.aoindustries.html.Html, com.semanticcms.core.model.ElementContext, com.semanticcms.core.servlet.PageIndex)}
	 *
	 * @see  #writeTo(javax.servlet.ServletRequest, com.aoindustries.html.Html, com.semanticcms.core.model.ElementContext, com.semanticcms.core.servlet.PageIndex)
	 */
	@Deprecated
	@Override
