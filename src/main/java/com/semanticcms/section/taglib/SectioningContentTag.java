...
abstract public class SectioningContentTag<SC extends SectioningContent> extends ElementTag<SC> {
	...
	/**
	 * @deprecated  You should probably be implementing in {@link #writeTo(javax.servlet.ServletRequest, com.aoindustries.html.any.AnyPalpableContent, com.semanticcms.core.model.ElementContext, com.semanticcms.core.renderer.html.PageIndex)}
	 *
	 * @see  #writeTo(javax.servlet.ServletRequest, com.aoindustries.html.any.AnyPalpableContent, com.semanticcms.core.model.ElementContext, com.semanticcms.core.renderer.html.PageIndex)
	 */
	@Deprecated
	@Override
